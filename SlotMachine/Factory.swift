...
//  SlotMachine
//
//  Created by Sebastian Burek on 09.03.2015.
...
class Factory {
    class func createSlots() -> [[Slot]] {
        ...
        // slots = [ [slot1, slot2], [slot3, slot4, slot 5], [slot6] ]
        // mySlotArray = slots[]   (czyli slot1 i slot2)
        // slot = ,mySlotArray [1]   (czyli slot2)
        
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            var slotArray:[Slot] = []
            for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber {
         //       var slot = Slot(value: 0, image: UIImage(named: ""), isRed: true)
         //       Above was the initial code setting slot to default value
         //       before the createSlot function was created.
         //       Below - new version calling on createSlot class function
